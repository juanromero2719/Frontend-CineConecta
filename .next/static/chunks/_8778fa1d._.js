...
const loginAdapter = {
    async loginUser (payload) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["axiosInstance"].post('login', payload, {
            headers: {
...
;
;
const CardLoginRegister = ({ onSubmit })=>{
    _s();
...
_s(CardLoginRegister, "BkA50nIZKuIojqIkBjWRzaBQUvU=");
