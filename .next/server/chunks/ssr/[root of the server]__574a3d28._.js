...
"[project]/adapters/getUsers.adapters.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getUsersAdapter = {
    async getUsers () {
        try {
            return await __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$axiosInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["axiosInstance"].get('/users');
        } catch (error) {
...
"[project]/src/app/(dashboard)/dashboard/hooks/useUser.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$adapters$2f$getUsers$2e$adapters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/adapters/getUsers.adapters.ts [app-ssr] (ecmascript)");
...
const useUser = ()=>{
    ...
    const getUsers = async ()=>{
        const result = await callEndpoint({
            call: __TURBOPACK__imported__module__$5b$project$5d2f$adapters$2f$getUsers$2e$adapters$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getUsersAdapter"].getUsers()
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$dashboard$2f$hooks$2f$useUser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/(dashboard)/dashboard/hooks/useUser.ts [app-ssr] (ecmascript)");
'use client';
;
;
const DashboardUsers = ()=>{
    const { getUsers, loading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f28$dashboard$292f$dashboard$2f$hooks$2f$useUser$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useUsers"])();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__574a3d28._.js.map