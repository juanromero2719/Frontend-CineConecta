...
"[project]/src/config/notifications.config.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$esm$2e$all$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].mixin(swalConfig);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$notifications$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/notifications.config.ts [app-ssr] (ecmascript)");
;
const showSuccess = (title, message)=>{
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$notifications$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
        icon: 'success',
        title,
        text: message,
...
const showConfirm = (title, message)=>{
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$notifications$2e$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].fire({
        icon: 'question',
        title,
        text: message,
        showCancelButton: true,
...
//# sourceMappingURL=src_44a6f817._.js.map